...
class PageDining extends StatefulWidget {
  const PageDining({Key? key}) : super(key: key);

  @override
  _PageDiningState createState() => _PageDiningState();
}

class _PageDiningState extends State<PageDining> {
  @override
        ...
        child: ListView(
          children: [
            ...
            ListTile(
              ...
              onTap: () {
                context.pushRoute(PageWebView(
                  title: 'Menu',
                  url:
                      'https://dineoncampus.com/northwestern/whats-on-the-menu',
                ));
              },
              title: Text(
                'What\'s On The Menu?',
            ...
            ListTile(
              ...
              onTap: () {
                context.pushRoute(PageWebView(
                  ...
                  url:
                      'https://dineoncampus.com/northwestern/hours-of-operation',
                ));
              },
              title: Text(
                'Hours of Operation',
            ...
            ListTile(
              ...
              onTap: () {
                context.pushRoute(PageWebView(
                    title: 'Meal Plan FAQs',
                    url: 'https://dineoncampus.com/northwestern/meal-plan-faqs',
                    jscode: jscodeFaq));
              },
              title: Text(
                'Meal Plan FAQs',
