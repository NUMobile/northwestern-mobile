          ...
          children: [
            ...
            InkWell(
              onTap: () => context.pushRoute(
                  PageWebBrowse(url: 'https://maps.northwestern.edu/evanston')),
              child: Container(
                margin: EdgeInsets.symmetric(
                    horizontal:
            ...
            InkWell(
              onTap: () => context.pushRoute(
                  PageWebBrowse(url: 'https://maps.northwestern.edu/chicago')),
              child: Container(
                margin: EdgeInsets.symmetric(
                    horizontal:
                        MediaQuery.of(context).size.width * MARGIN_RATIO,
            ...
            InkWell(
              onTap: () {
                context.pushRoute(
                  PageWebBrowse(
                      url:
                          'https://www.mccormick.northwestern.edu/contact/tech-room-finder.html',
                      jscode: jscodeTech),
                );
              },
              child: Container(
            ...
            InkWell(
              onTap: () => context.pushRoute(PageMapPdf(
                  ...
                  path: 'assets/PDF/EV_campusmap.pdf')),
              child: Container(
                margin: EdgeInsets.symmetric(
                    horizontal:
                        MediaQuery.of(context).size.width * MARGIN_RATIO,
